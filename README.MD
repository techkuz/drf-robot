This project uses Django + Django Rest Framework. They provide an easy and fast way to create efficient and customizable API's. As a deployment service Docker is used.
